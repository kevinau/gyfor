...
import org.gyfor.busnum.IBusinessLookup;
...
@Component(configurationPolicy = ConfigurationPolicy.REQUIRE,
           property="country=AU")
public class ABNLookup implements IBusinessLookup {
  ...
  public String getBusinessName(String businessNumber) throws IOException {
    ...
    try {
      result = searchByABN(authenticationGUID, businessNumber, false);
      ...
      if (result.isException()) {
        ...
        return result.getOrganisationName();
      }
