...
public class ClassifierTest4 {
  ...
  private IDocumentClassifier classifier;
  
  @Reference
  protected void setClassifier (IDocumentClassifier classifier) {
    this.classifier = classifier;
  }
  
  protected void unsetClassifier (IDocumentClassifier classifier) {
