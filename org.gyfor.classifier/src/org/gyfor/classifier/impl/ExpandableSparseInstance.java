...
public class ExpandableSparseInstance extends AbstractInstance {
  ...
  // */
  // public ExpandableSparseInstance(Instance instance) {
  //
   ...
   */
  public ExpandableSparseInstance(ExpandableSparseInstance instance) {
   ...
   */
  public ExpandableSparseInstance(double weight, double[] attValues) {

    m_Weight = weight;
    m_Dataset = null;
    int na = numAttributes();
    double[] tempValues = new double[na];
    int[] tempIndices = new int[na];
    int vals = 0;
    for (int i = 0; i < na; i++) {
      if (attValues[i] != 0) {
   ...
   */
  public ExpandableSparseInstance(double weight, double[] attValues, int[] indices) {
...
//   */
//  public ExpandableSparseInstance(int numAttributes) {
//
...
//  }
  ...
  public Object copy() {
    ...
    ExpandableSparseInstance result = new ExpandableSparseInstance(this);
  ...
  public Instance mergeInstance(Instance inst) {
    ...
    return new ExpandableSparseInstance(1.0, values, indices);
  }
  ...
  public double[] toDoubleArray() {
    int na = numAttributes();
    double[] newValues = new double[na];
    for (int i = 0; i < m_AttValues.length; i++) {
   ...
   */
  protected ExpandableSparseInstance() {};
