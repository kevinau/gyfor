...
public class TestClassifier3 {
    ...
    public static void main(String args[]) {
        ...
        */
        ...
        TestClassifier3 classifier = new TestClassifier3(inputText, inputClasses, thisAttributeInfo, thisTextAttribute, thisClassAttribute, thisClassString);
    ...
    // constructor
    //
    TestClassifier3(String[] inputText, String[] inputClasses, FastVector attributeInfo, Attribute textAttribute, Attribute classAttribute, String classString) {
    ...
    public StringBuffer classify(String classString) {
        ...
        try {
            ...
            //
            classifier = AbstractClassifier.forName(classString,null);
