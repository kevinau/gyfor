...
public class DataFetchService implements IDataFetchService {
  ...
  private IDataFetchRegistry dataAccessRegistry;
  ...
  @Reference
  void setDataAccessRegistry (IDataFetchRegistry dataAccessRegistry) {
    this.dataAccessRegistry = dataAccessRegistry;
  }
