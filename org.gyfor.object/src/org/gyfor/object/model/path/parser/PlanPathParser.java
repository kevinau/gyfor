/* Generated By:JavaCC: Do not edit this line. PlanPathParser.java */
...
public class PlanPathParser implements PlanPathParserConstants {
  ...
  {
    PlanPathParser parser = new PlanPathParser(System.in);
    while (true) {
      parser.parse();
    }
  }

  public PlanPathParser () {
  ...
  public PlanPathParserTokenManager token_source;
  ...
  public PlanPathParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PlanPathParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new PlanPathParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public PlanPathParser(java.io.Reader stream) {
  ...
  public PlanPathParser(PlanPathParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(PlanPathParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
