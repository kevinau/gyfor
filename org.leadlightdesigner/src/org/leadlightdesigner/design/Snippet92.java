...
public class Snippet92 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // Create cursor
    Image whitePointer = new Image(display, Snippet92.class.getResource("/").getPath() + "icons8-cursor-white-32.png");
    Cursor cursor = new Cursor(display, whitePointer.getImageData(), 9, 3);
