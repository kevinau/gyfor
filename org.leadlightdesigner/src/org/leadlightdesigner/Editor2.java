...
public static void main(String[] args) {
	...
	Editor2 application = new Editor2();
...
private boolean close() {
  if (isModified) {
    ConfirmNoSaveDialog noSaveDialog = new ConfirmNoSaveDialog(shell, "", "");
    int result = noSaveDialog.show();
    switch (result) {
    case 0 :
      return save();
    case 1 :
...
private void createFileMenu(Menu menuBar) {
	...
	subItem.setText(resAddressBook.getString("New_design"));
  ...
  //File -> Close.
  subItem = new MenuItem(menu, SWT.NONE);
  subItem.setText(resAddressBook.getString("Close_design"));
  ...
  //File -> Save.
  subItem = new MenuItem(menu, SWT.NONE);
  subItem.setText(resAddressBook.getString("Save_design"));
  subItem.setAccelerator(SWT.MOD1 + 'S');
  subItem.addSelectionListener(widgetSelectedAdapter( e -> save()));

	//File -> Save As.
	subItem = new MenuItem(menu, SWT.NONE);
	subItem.setText(resAddressBook.getString("Save_design_as"));
	subItem.setAccelerator(SWT.MOD1 + SWT.SHIFT + 'S');
